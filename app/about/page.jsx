      ...
      <div className="mx-auto max-w-shell px-6 py-16">
        <div className="grid gap-14 lg:grid-cols-[1.3fr_1fr]">
          <div className="space-y-10">
            <section>
              <h2 className="h-display text-[24px] text-primary">Who we supply</h2>
            ...
            <section>
              <h2 className="h-display text-[24px] text-primary">How we work</h2>
              <dl className="mt-5 space-y-5">
                {[
                  ...
                  <div key={t} className="border-l-2 border-secondary pl-5">
                    <dt className="h-display text-[17px] text-primary">{t}</dt>
                    <dd className="mt-2 text-[14px] leading-relaxed text-ink/70">{d}</dd>
                  </div>
                ))}
              </dl>
            </section>

            <section className="border border-accent/30 bg-accent/[0.04] p-6">
              <h2 className="h-display text-[19px] text-primary">On class approval</h2>
          ...
          <aside className="space-y-8">
            <dl className="border border-primary/12 bg-base px-5 py-2">
              {[
                ...
                <div key={k} className="border-b border-primary/8 py-3.5 last:border-0">
                  <dt className="eyebrow text-ink/70">{k}</dt>
                  <dd className="data mt-1.5 text-[13px] leading-relaxed text-primary">{v}</dd>
                </div>
              ))}
            </dl>

            <div className="grid grid-cols-3 divide-x divide-primary/10 border border-primary/12 bg-base">
              {[
                ...
                <div key={l} className="px-4 py-6 text-center">
                  <p className="h-display data text-[24px] text-secondary-ink">{n}</p>
                  <p className="mt-1 text-[12px] text-ink/70">{l}</p>
                </div>
              ))}
            </div>
